...
void setup()
{
  ...
  cp5.addSlider("Sensore1").setPosition(800, 700).setSize(100, 20).setRange(0, 200).setColorForeground(color(#FFA000));
  /*
...
void draw()
{
  ...
  if (value <= 180 && value >= 100)
  {
    ...
    */
    cp5.getController("Sensore1").setValue(value);
    cp5.getController("Sensore1").setColorBackground(color(255,0,0));
  }
